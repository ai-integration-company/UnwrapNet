...
def load_EfficientNet():
    effnetb1full_pytorch_default_1_path = kagglehub.model_download(
        "vasiliygorelov/effnetb1full/PyTorch/default/1"
    )
...
def load_ResNet():
    resnet18full_pytorch_default_1_path = kagglehub.model_download(
        "vasiliygorelov/resnet18full/PyTorch/default/1"
    )
...
def load_autoML():
    automlnorm_other_default_1_path = kagglehub.model_download(
        "vasiliygorelov/automlnorm/Other/default/1"
    )
